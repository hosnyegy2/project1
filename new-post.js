    ...
    function displayMatch(match, matchFormation, analysis, matchSK) {
        ...
        const content = `
            ...
            <div class="tab-content active">
                ...
                <h3>ملعب المباراة</h3>
                <p>تُقام مباراة ${match.team_A_name} و${match.team_B_name} على ملعب ${venueName} وسط أجواء وطقس  ${weather==='Partly Cloudy' ? 'غائم جزئياً' : weather==='Overcast' ? 'ملبد بالغيوم' : weather==='Sunny' ? 'مشمس' : weather} ودرجة حرارة تبلغ ${temperature}.</p>
                <h3>حكم المباراة</h3>
                <p>حكم المباراة هو الشخصية المسؤولة عن إدارة اللقاء والتحكيم بين الفريقين بشكل عادل وفقًا لقوانين اللعبة. يتمتع الحكم بخبرة كبيرة تمكنه من اتخاذ القرارات الحاسمة في اللحظات المهمة خلال المباراة. اليوم، يتولى قيادة هذا اللقاء الحكم ${referee}، والذي يُعرف بمسيرته المهنية الحافلة وتميزه في إدارة المباريات على مختلف المستويات.</p>
