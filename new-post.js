     ...
     const content = `
        <div class="match">
            ...
            <div class="tab-content active">
                ...
                <h3>ملعب المباراة</h3>
                <p>تُقام مباراة ${match.team_A_name} و${match.team_B_name} على ملعب ${venueName} وسط أجواء وطقس  ${weather==='Partly Cloudy' ? 'غائم جزئياً' : weather==='Overcast' ? 'ملبد بالغيوم' : weather==='Sunny' ? 'مشمس' : weather==='Cloudy with Rain' ? 'غائم ممطر' : weather} ودرجة حرارة تبلغ ${temperature}.</p>
                <h3>حكم المباراة</h3>
