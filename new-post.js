     ...
     const content = `
        <div class="match">
            ...
            <div class="post-info">
                ...
                <h3>ملعب المباراة</h3>
                <p>تُقام مباراة ${match.team_A_name} و${match.team_B_name} على ملعب ${venueName} وسط أجواء مميزة، حيث يُتوقع أن يكون الطقس  ${weather==='Partly Cloudy' ? 'غائم جزئياً' : weather==='Overcast' ? 'ملبد بالغيوم' : weather==='Sunny' ? 'مشمس' : weather==='Cloudy with Rain' ? 'غائم ممطر' : weather==='Cloudy' ? 'غائم' : weather}. تبلغ درجة الحرارة حوالي ${temperature}، مما يُعزز من إثارة المباراة ويجعلها تحديًا إضافيًا للاعبين في تقديم أفضل أداء ممكن وسط تلك الظروف المناخية. هذا الطقس قد يلعب دورًا في أسلوب اللعب ويُضيف عنصرًا تكتيكيًا يجب على الفريقين أخذه بعين الاعتبار خلال المباراة.</p>
                <h3>حكم المباراة</h3>
